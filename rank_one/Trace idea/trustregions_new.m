function [x, cost, info, options] = trustregions_new(problem, x, options)
...
while true
    ...
    if isfield(options,'aug') && options.aug ==1,
        [eta, Heta, numit, stop_inner] = ...
            tCG_aug(problem, x, fgradx, eta, Delta, options, storedb, key);
    else
        [eta, Heta, numit, stop_inner] = ...
